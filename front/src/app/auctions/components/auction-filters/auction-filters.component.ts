...
export class AuctionFiltersComponent implements OnInit {
  ...
  applyClick() {
    if (this.form.valid) {
      const filters = new AuctionFilters(this.form.value.condition, this.form.value.type, this.form.value.minBuyNow, this.form.value.maxBuyNow, this.form.value.minAuction, this.form.value.maxAuction);
