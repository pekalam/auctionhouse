CREATE PROCEDURE [dbo].[test insert_event when expected version equals 0 and event already exist sets version to newVersion]
AS
BEGIN
    declare @count int;
    declare @expectedCount int = 2;
    declare @version bigint;
    declare @expectedVersion bigint = 3;
    ...
    execute dbo.insert_event @AggId = @aggId, @AggName = 'agg1', @EventName = 'event 1', @Date = @now, @Data = '{"a": 1}', @ExpectedVersion = 0, @NewVersion = 3
