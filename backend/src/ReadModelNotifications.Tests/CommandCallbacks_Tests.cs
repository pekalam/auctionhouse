...
namespace ReadModelNotifications.Tests
{
    public class CommandCallbacks_Tests
    {
        ...
        private ICommandHandlerCallbacks SetupCommandHandlerCallbacks(CommandNotificationSettings[] commandNotificationSettings)
        {
            ...
            services.AddCommandReadModelNotifications((_) => _mockImmediateNotifications.Object, (_) => _mockSagaNotifications.Object, null, (_) => new StubNotificationReader(commandNotificationSettings),
