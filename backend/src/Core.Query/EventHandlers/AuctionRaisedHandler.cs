...
{
    //public class AuctionRaisedHandler : EventConsumer<AuctionPriceRised>
    //{
    ...
    //    private void UpdateAuction(AuctionPriceRised ev, IClientSessionHandle session)
    //    {
    ...
    //    private void UpdateUser(AuctionPriceRised ev, IClientSessionHandle session)
    //    {
    ...
    //    public override void Consume(IAppEvent<AuctionPriceRised> message)
    //    {
    //        AuctionPriceRised ev = message.Event;
